                                                      ...
                                                      <form class="profile-info-form">
                                                         <div class="row mrg20">
                                                            <div class="col-md-12 col-sm-12 col-lg-12">
                                                               ...
                                                               <input type="text" onkeypress="return /[a-z/A-Z]/i.test(event.key)" class="brd-rd3"    value="<?php  echo $row['FirstName'];?>" id="firstname" name="firstname" required="true">
                                                            </div>
                                                            <div class="col-md-12 col-sm-12 col-lg-12">
                                                               <label>Last Name <sup>*</sup></label>
                                                               <input class="brd-rd3" onkeypress="return /[a-z/A-Z]/i.test(event.key)" type="text" value="<?php  echo $row['LastName'];?>" id="lastname" name="lastname" required="true">
                                                            </div>
                                                            <div class="col-md-12 col-sm-12 col-lg-12">
