                    ...
                    <form class="sign-form" name="signup" onsubmit="return checkpass();" method="post">
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-lg-6">
                                <input class="brd-rd3" type="text" onkeypress="return /[a-z/A-Z]/i.test(event.key)" id="firstname" name="firstname" required="true" placeholder="First Name">
                            </div>
                            <div class="col-md-6 col-sm-6 col-lg-6">
                                <input class="brd-rd3" type="text" onkeypress="return /[a-z/A-Z]/i.test(event.key)"  id="lastname" name="lastname" required="true" placeholder="Last Name">
                            </div>
