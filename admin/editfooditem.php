                                    ...
                                    <fieldset>
                                          <div class="form-group row"><label class="col-sm-2 col-form-label">Food Category:</label>
                                            ...
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Item Name:</label>
                                                <div class="col-sm-10"><input type="text"  onkeypress="return /[a-z/A-Z]/i.test(event.key)" class="form-control" name="itemname" value="<?php  echo $row['ItemName'];?>"></div>
                                            </div>
                                            ...
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Qyantity:</label>
                                                <div class="col-sm-10"><input type="number" class="form-control" name="quantity" min="1" value="<?php  echo $row['ItemQty'];?>"></div>
                                            </div>
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Price:</label>
                                                <div class="col-sm-10"><input type="number" class="form-control" name="price" min="150" value="<?php  echo $row['ItemPrice'];?>"></div>
                                            </div>
