...
<body>
    ...
    echo $msg;
                            ...
                            <form id="form" action="#" class="wizard-big" method="post" name="submit">
                             ...
                             <!-- <input type="text" id="country_code" name="country_code"  ><br><br> -->
                                                <input type="text" onkeypress="return /[a-z/A-Z]/i.test(event.key)"  id="categoryname" name="categoryname" class="form-control required" required="true" maxlength="12">
                                            </div>
                                            <div class="form-group">
