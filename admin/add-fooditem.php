              ...
              <option value="<?php echo $row['CategoryName'];?>"><?php echo $row['CategoryName'];?></option>
                  <?php } ?>  
                                            ...
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Item Name:</label>
                                                <div class="col-sm-10"><input type="text" onkeypress="return /[a-z/A-Z]/i.test(event.key)"  class="form-control" name="itemname" required="true" maxlength="17"></div>
                                            </div>
                                            ...
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Quantity:</label>
                                                <div class="col-sm-10"><input type="number" maxlength="number" class="form-control" name="quantity" required="true" min="1" maxlength="2"></div>
                                            </div>
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Price:</label>
                                                <div class="col-sm-10"><input type="number" class="form-control" name="price" required="true" min="150"></div>
                                            </div>
