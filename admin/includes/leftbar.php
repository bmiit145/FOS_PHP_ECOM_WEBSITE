...
?>
 ...
 <li>
                ...
                <li>
                    <a href="feedback.php"><i class="fa fa-users"></i> <span class="nav-label">Feed back </span> <span class="fa arrow"></span></a>
                 </li>
                 <li>
                    <a href="review.php"><i class="fa fa-users"></i> <span class="nav-label">Review</span> <span class="fa arrow"></span></a>
                 </li>
                <li>
