                                    ...
                                    <div class="row">
                                        <div class="col-lg-8">
                                            <div class="form-group">
                                                ...
                                                <input id="categoryname" name="categoryname" type="text"  onkeypress="return /[a-z/A-Z]/i.test(event.key)" class="form-control required" required="true" value="<?php  echo $row['CategoryName'];?>">
                                            </div>
                                            <?php } ?>
                                            <div class="form-group">
